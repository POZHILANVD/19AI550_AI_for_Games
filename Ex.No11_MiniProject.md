...
### Algorithm:
STEP 1: To write a python program to simulate the game Space-Invaders-Pygame-master using ai technique  Finite State Machine.
STEP 2: Then add background images and add the enemy images and the player images.
STEP 3: Then add some sound effects for the game.
STEP 4: Then add score to count the score .
### Program:
```
import math
import random
...
### Output:
![Screenshot (247)](https://github.com/user-attachments/assets/81bdd176-9a23-4a9b-8658-8bb812394257)

![Screenshot (248)](https://github.com/user-attachments/assets/b30547ae-c720-4168-be12-c171a7332c99)

### Result:
Thus the simple  game was implemented using Finite State Machine.
